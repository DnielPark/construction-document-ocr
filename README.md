...
- **이미지 1장**: 약 1,000 tokens = **$0.001 (약 1-2원)**
- **CLOVA OCR 대비**: **12배 저렴!**
- **월 100장 처리**: 약 100-200원
- **월 1,000장 처리**: 약 1,000-2,000원
...
## 🎯 Claude Haiku Vision 장점
1. **비용 최적화**: Sonnet의 1/3 가격, CLOVA의 1/12 가격
2. **속도 최고**: 가장 빠른 응답 속도
3. **표 인식 우수**: Haiku도 표, 문서 인식 잘함
4. **맥락 이해**: "지 반 고" → "지반고" 자동 수정
5. **구조화 출력**: 바로 JSON으로 깔끔한 데이터
